...
const SECTIONS = [
  ...
  },
  {
    ...
    tips: [
      { title: 'Estándar de volumen: -14 LUFS', desc: 'Spotify normaliza a -14 LUFS. YouTube a -13 LUFS. No masters más alto o cortarán tu volumen automáticamente.' },
      { title: 'Limiter al final de la cadena', desc: 'Un buen limiter (como FabFilter Pro-L 2, Ozone) con True Peak de -1dBTP evita distorsión en reproductores digitales.' },
